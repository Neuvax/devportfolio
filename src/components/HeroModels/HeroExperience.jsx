...
import { PERFORMANCE_CONFIG, detectGPUPerformance } from "../../lib/performanceConfig";
...
const HeroExperience = () => {
  ...
  if ((isDev && config.useStaticImage) || (performanceLevel === 'low' && isMobile)) {
    return (
      <div className="w-full h-full flex items-center justify-center">
        ...
        <div className="absolute bottom-5 left-5 bg-black-50 p-2 rounded text-xs text-white-50">
          3D model deactivated for performance reasons.
        </div>
      </div>
    );
  }
